r"""Lab 2.2 (SOLUTION) — hybrid retrieval: fuse BM25 keyword + vector search.

Run:  python lab_2_2_hybrid_retrieval_solution.py <emails_dir>
...
class HybridRetriever(BaseRetriever):
    def __init__(self, emails_dir: str, db: Chroma, **kwargs):
        ...
        # Keyword index over the same emails (kept in memory).
        paths = sorted(
