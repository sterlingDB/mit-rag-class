r"""Lab 3.1 (SOLUTION) — evaluate the retrievers with RAGAS.
...
The test questions are in testInputs.json (question + grading_notes per row).
...
then compare the pass rates across the three approaches:
    python lab_3_1_evaluation_solution.py bm25   detailedEmails
    python lab_3_1_evaluation_solution.py vector detailedEmails
    python lab_3_1_evaluation_solution.py hybrid detailedEmails
...
# JUDGE_MODEL) is the Step 2 exercise.
